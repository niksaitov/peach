...
void AttackTable::initialiseLeapingPieceTables()
{
    ...
    for (int squareIndex = 0; squareIndex < 64; squareIndex++)
    {
        ...
        // Initialise leaping piece attacks
...
// Get pawn attacks
U64 AttackTable::getPawnAttacks(uint color, int squareIndex) const
{
    // Fetch the attacks
    return pawnAttacks[color][squareIndex];
}

// Get knight attacks
U64 AttackTable::getKnightAttacks(int squareIndex) const
{
    // Fetch the attacks
...
// Get king attacks
U64 AttackTable::getKingAttacks(int squareIndex) const
{
    // Fetch the attacks
...
// Get bishop attacks
U64 AttackTable::getBishopAttacks(int squareIndex, U64 occupancy) const
{
...
// Get rook attacks
U64 AttackTable::getRookAttacks(int squareIndex, U64 occupancy) const
{
    // Convert the occupancy into the index of the attack table
...
// Get queen attacks
U64 AttackTable::getQueenAttacks(int squareIndex, U64 occupancy) const
{
